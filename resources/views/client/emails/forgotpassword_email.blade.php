<div class='container email-container'>
    ...
    <div class='email-header'>
        <div class='content text-dark'>
            ...
            <p class='text'>
                YOUR SWEEPING COSTS WITH THE GADGETOY BY CURSOR LTD
            </p>
            <h2 class="text-dark">Click
                <a href="{{route('forgot-passwordsendemaildone',["email"=> $Client->email,"varify_token"=> $Client->varify_token])}}">
                    here</a> and verify your identity
            </h2>
        </div>
        <img>
    </div>
    ...
    <div class='email-footer'>
        ...
        <div class='copywrite'>
            <p>© 2020 Gadgetoy. All Rights Reserved.</p>
        </div>
        <div class='address'>
            <p class='name'>11/11 Jobeda Villa, Panchlaish, Chittagong, Bangladesh</p>
        </div>
    </div>
</div>
