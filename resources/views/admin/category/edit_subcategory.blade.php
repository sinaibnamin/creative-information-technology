                   ...
                   <option value="" selected disabled>Select Root Category</option>
                    ...
                    <div class="form-group">
                        ...
                        <input id="category_name" name="category_name" value="{{$category->category_name}}"
                               ...
                               style="border-radius: 20px;">
                               <label for="type_name" class="mt-3">Short Name</label>
                               <input id="category_name" name="short_name" value="{{$category->short_name}}" class="form-control form-control-lg" type="text" placeholder=""  required
                               style="border-radius: 20px;">
                    ...
                    <div class="form-check">
                     ...
                     <div class="form-group mt-3">
                        ...
                        <div class="radio">
                          ...
                          <label>  <input type="radio" {{$category->status==0 ? 'checked' : '' }} name="status" value="0"> Inactive </label>
                        </div>
