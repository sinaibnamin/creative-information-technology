                ...
                <div class="card-body">
                    <form class="form-group" action="{{route('save-product')}}" method="POST"
                        ...
                        <br>
                           <div class="form-row">
                            <div class="col">
                                ...
                                <textarea class="form-control" name="product_specification" id="summary_editor"></textarea>
                                <small class="text-danger"></small>
                            </div>
                        </div>
                        {{--
                        ...
                        <div class="col-md-3" >
                            ...
                            <input type="hidden" value={{$v_heading->heading}} name="heading_id[]" class="form-control">
                            </div>
                    ...
                    <br>
                        ...
                        <div class="form-row">
                            ...
                            <span class="icon text-white-50">
                                ...
                                <input required id="file-upload" style="display: none" type="file"
                                       name="product_image"/>
