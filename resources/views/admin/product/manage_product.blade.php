      ...
      <div class="container-fluid" >
        ...
        <div class="card mb-3" id="productData">
          <div class="card-header bg-white">
            ...
            <div class="col">
                <label>Model</label>
                    <input  type="text" class="form-control form-control-sm" id="model_number" name="model_number"/>
            ...
            <div class="table-responsive">
              <table class="table table-bordered" style="border-style: dashed" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <td>{{$v_product->model_number}}</td>
                    <td>{{$v_product->discount}}৳ / {{$v_product->discount_percent}}%</td>
                    <td>{{$v_product->currency}}{{$v_product->product_price}} </td>
                    @if($v_product->status ==1)
                    <td>Active</td>
                    @elseif($v_product->status == 0)
                    <td>Inactive</td>
                    @endif
                    <td>
                        <a
...
<script src="{{asset('public/admin/custom/api.js')}}"></script>
<script src="{{asset('public/admin/custom/product_search.js')}}"></script>
