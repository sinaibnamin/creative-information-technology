                    ...
                    <form class="form-group" action="{{route('update-product')}}" method="POST" enctype="multipart/form-data" name="editProductForm">
                        ...
                        <div class="form-row">
                           ...
                           <!--category was here-->
                            <div class="col">
                                ...
                                <select required class="form-control form-control-sm" id="pc" name="cat_level_one" >
                                    <option value="0">select</option>
                            ...
                            <div class="col">
                                <label for="pc">Sub Sub Category</label>
                                <select required class="form-control form-control-sm" id="pc" name="cat_level_two" >
                                    <option value="0">select</option>
                                    @foreach($subCategories as $v_category)
                                    @foreach($subSubCategories as $vs_category)
                                    @if($vs_category->root_id==$v_category->id)
                                        <option value="{{$vs_category->id}}">{{$vs_category->category_name}}</option>
                                    @endif    
                                    @endforeach
                                    @endforeach
                                </select>
                            </div>
                            <!--<div class="col" id="cat_level_one" >-->
                            ...
                            <!--    </select>-->
                            <!--</div>-->
                            <!--<div class="col" id="cat_level_two" >-->
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input required value="{{$product->model_number}}" type="text" class="form-control form-control-sm" id="pr"
                                       name="model_number"/>
                        ...
                        <br>
                            ...
                            <div class="col">
                                ...
                                <textarea required type="text" class="form-control" name="product_specification" id="summary_editor">{!! $product->product_specification !!}</textarea>
                                <small class="text-danger"></small>
                            </div>
                        </div>
                        {{--
                      @foreach($specification as $v_spe)
                       ...
                       --}}
                        ...
                        @if($product->status==1)
                        <input type="checkbox" checked name="home_page" value="1" class="form-check-input" id="exampleCheck1">
                        @else
...
@endif
 ...
 <br>
    ...
    <script>
        ...
        document.forms['editProductForm'].elements['category_id'].value = '{{ $product->category_id }}';
        document.forms['editProductForm'].elements['cat_level_one'].value = '{{ $product->subcategory_id }}';
        document.forms['editProductForm'].elements['cat_level_two'].value = '{{ $product->sub_sub_cat_id }}';
