                ...
                <tbody>
                  ...
                  <td>{{$v_client->nid}}</td> 
                    ...
                    href="" 
                       ...
                       @if($v_client->activity == 0)
                    <a href="{{route('client-active',['id' => $v_client->id])}}"><b style="color:green">active</b></a>   ||
                       @else
                        <a href="{{route('client-deactive',['id' => $v_client->id])}}"><b style="color:red">inactive</b></a>
                       @endif
                    </td>
                  </tr>
                 @endforeach 
